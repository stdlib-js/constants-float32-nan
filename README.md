...
```javascript
import FLOAT32_NAN from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-nan@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-nan/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/constants-float32-nan/actions/workflows/test.yml?query=branch:v0.2.3
